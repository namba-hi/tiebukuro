...
# 概要
このアプリは日常の役立つ生活を共有することを目的に作られたアプリです。
みんなで知恵袋を共有する。私たちの知恵袋(Our wisdom bag)として制作しました。
記事を作成するときにカテゴリを選んでもらい、カテゴリ毎の役立つ記事を投稿できるようにしています。中には、信頼性のない記事が投稿されることもあるため、信頼性の高いものや役立った記事にコメントやいいねをつけられるようにしました。カテゴリ毎の記事の表示やタイトルから記事を検索することも可能です。

# URL
https://ourwisdombag.herokuapp.com/

使用する場合のテストアカウント
- Email:test@gmail.com
- password:010101

テストアカウントを使用した後はログアウトをお願いします。
